# Generated by Django 4.0.3 on 2022-03-21 18:18
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_of_birth', models.DateField(blank=True, null=True, verbose_name='Дaтa рождения')),
                ('date_of_death', models.DateField(blank=True, null=True, verbose_name='Дaтa смерти')),
            ],
        ),
        migrations.CreateModel(
            name='Book',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=20, verbose_name='Cтaтyc экземпляра книги')),
            ],
        ),
        migrations.CreateModel(
            name='BookInstance',
            fields=[
                ...
                ('status', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='catalog.status', verbose_name='Cтaтyc экземпляра книги')),
            ],
        ),
        migrations.AddField(
            model_name='book',
